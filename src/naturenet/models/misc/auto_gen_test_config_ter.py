...
#fname = ["/data/nlahaye/NatureNet_Env/Bath/gebco_2025_sub_ice_n40.0_s20.0_w-100.0_e-60.0_geotiff.tif"]

 
yml_fname = "../../config/environment/basic_env_setup_2.yaml"
  
bath_fglob_begin = "/data/nlahaye/NatureNet_Env/Bath/gebco_"
...
sss_fglob_begin = "/data/nlahaye/NatureNet_Env/SSS/dataset-sss-ssd-rep-daily_"

sss_fglob_date_str = "%Y%m%d"

sst_fglob_begin = "/data/nlahaye/NatureNet_Env/SST/oisst-avhrr-v02r01."
sst_fglob_date_str = "%Y%m%d" 
 
sdate = "01112023T00:00:00Z"
edate = "10102024T23:59:59Z"
  
coastal_dist_fname = "/data/nlahaye/NatureNet_Env/Coastal_Dist/GMT_intermediate_coast_distance_01d.tif"
...
while current_date < end_date:
    ...
    if date_ind >= 10:
        ...
        new_fname = os.path.splitext(yml_fname)[0] + "NEW_SET_RECENT_YEARS_" + str(file_ind) + ".yaml"
        print(new_fname)
